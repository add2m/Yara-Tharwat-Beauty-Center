...
# ============================================================
# 2. كود الـ CSS الملكي (تنسيق احترافي)
# ============================================================
st.markdown("""
<style>
...
if p == "home":
    ...
    menu = [("📅 للحجز والاستفسار", "booking"), ("💰 الأسعار والعروض", "prices"), ("🎥 معرض فيديوهاتنا", "gallery"), ("⭐ آراء الجميلات", "reviews")]
    ...
    # 2. عرض الآراء (كودك بتنسيق السنتر)
    ...
    with st.expander("🔐 إدارة التعليقات"):
        pwd = st.text_input("كلمة المرور للحذف", type="password")
        if pwd == ADMIN_PWD:
